                            ...
                            <Tr key={course.id}>
                                ...
                                <Td className="text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        ...
                                        <button onClick={() => navigate(ROUTES.INSTRUCTOR_COURSE_CREATE)} title="Edit Course" className="p-2 text-text-muted hover:text-violet-600 hover:bg-violet-50 rounded-lg transition-colors">
